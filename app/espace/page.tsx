...
const spaces = [
  ...
  { href: "/espace/admin", role: "ADMIN", eyebrow: "Espace administration", title: "Administrez la plateforme.", text: "Utilisateurs, contenus, statistiques et configuration opérationnelle." },
...
export default async function EspacePage() {
  ...
  const allowed = spaces.filter((space) => session.user.role === space.role || (session.user.role === "ADMIN" && space.role !== "OWNER"));
