    ...
    <section className="mx-auto w-[min(1280px,calc(100%-40px))] py-12 md:py-20">
      ...
      <div className="mt-8 border border-white/10 bg-[#111] p-6">
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-3">
          <div className="md:col-span-3">\n            <label htmlFor="real-cv-file" className="mb-2 block text-[9px] uppercase tracking-[0.16em] text-white/35">Sélectionner un CV</label>\n            <input id="real-cv-file" type="file" accept=".pdf,.doc,.docx,.jpeg,.jpg,application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,image/jpeg" onChange={(e) => setFile(e.target.files?.[0] || null)} className="block w-full cursor-pointer border border-white/10 bg-[#0b0b0b] px-3 py-3 text-sm text-white/70 file:mr-4 file:border-0 file:bg-[#c7a15a] file:px-4 file:py-2 file:text-[10px] file:uppercase file:tracking-[0.14em] file:text-[#111] hover:border-[#c7a15a] focus:outline-none" />\n            <p className="mt-2 text-[10px] text-white/30">PDF, DOC, DOCX, JPEG/JPG · fichier réel sélectionné : {file ? file.name : "aucun"}</p>\n          </div>
