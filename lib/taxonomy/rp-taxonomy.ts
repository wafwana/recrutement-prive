...
export const RP_TAXONOMY: TaxonomyNode[] = [
  { code: "INDUSTRIE", name: { fr: "Industrie", en: "Industry", es: "Industria", de: "Industrie", it: "Industria", ar: "الصناعة" },
  ...
  { code: "LOGISTIQUE", name: { fr: "Logistique & Supply Chain", en: "Logistics & Supply Chain", es: "Logística y Supply Chain", de: "Logistik & Supply Chain", it: "Logistica e Supply Chain", ar: "اللوجستيات وسلسلة الإمداد" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "COMMERCE", name: { fr: "Commerce & Business", en: "Sales & Business", es: "Comercio y Negocio", de: "Vertrieb & Business", it: "Vendite e Business", ar: "التجارة والأعمال" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "SERVICES", name: { fr: "Services", en: "Services", es: "Servicios", de: "Dienstleistungen", it: "Servizi", ar: "الخدمات" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "IT", name: { fr: "Informatique & Tech", en: "IT & Technology", es: "Tecnología e IT", de: "IT & Technologie", it: "IT e Tecnologia", ar: "تقنية المعلومات والتكنولوجيا" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "BTP", name: { fr: "BTP & Construction", en: "Construction", es: "Construcción", de: "Bau", it: "Edilizia", ar: "البناء والتشييد" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "FINANCE", name: { fr: "Finance", en: "Finance", es: "Finanzas", de: "Finanzen", it: "Finanza", ar: "المالية" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "RH", name: { fr: "Ressources Humaines", en: "Human Resources", es: "Recursos Humanos", de: "Personalwesen", it: "Risorse Umane", ar: "الموارد البشرية" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "DIRECTION_EXECUTIVE", name: { fr: "Direction & Haut Management", en: "Executive Leadership", es: "Dirección y Alta Dirección", de: "Geschäftsführung & Top Management", it: "Direzione e Top Management", ar: "الإدارة العليا" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "INGENIERIE", name: { fr: "Ingénierie & Sciences", en: "Engineering & Science", es: "Ingeniería y Ciencias", de: "Ingenieurwesen & Wissenschaft", it: "Ingegneria e Scienze", ar: "الهندسة والعلوم" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "SANTE", name: { fr: "Santé & Médico-social", en: "Healthcare & Care", es: "Salud y Atención", de: "Gesundheit & Pflege", it: "Sanità e Cura", ar: "الصحة والرعاية" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "ENERGIE_ENVIRONNEMENT", name: { fr: "Énergie & Environnement", en: "Energy & Environment", es: "Energía y Medio Ambiente", de: "Energie & Umwelt", it: "Energia e Ambiente", ar: "الطاقة والبيئة" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "BANQUE_ASSURANCE", name: { fr: "Banque & Assurance", en: "Banking & Insurance", es: "Banca y Seguros", de: "Banken & Versicherungen", it: "Banche e Assicurazioni", ar: "البنوك والتأمين" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "MARKETING_COMMUNICATION", name: { fr: "Marketing & Communication", en: "Marketing & Communications", es: "Marketing y Comunicación", de: "Marketing & Kommunikation", it: "Marketing e Comunicazione", ar: "التسويق والاتصال" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "JURIDIQUE", name: { fr: "Juridique & Compliance", en: "Legal & Compliance", es: "Legal y Compliance", de: "Recht & Compliance", it: "Legale e Compliance", ar: "القانون والامتثال" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "TRANSPORT_MOBILITE", name: { fr: "Transport & Mobilité", en: "Transport & Mobility", es: "Transporte y Movilidad", de: "Transport & Mobilität", it: "Trasporti e Mobilità", ar: "النقل والتنقل" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "AGROALIMENTAIRE", name: { fr: "Agroalimentaire & Agriculture", en: "Food & Agriculture", es: "Agroalimentación y Agricultura", de: "Lebensmittel & Landwirtschaft", it: "Agroalimentare e Agricoltura", ar: "الأغذية والزراعة" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "IMMOBILIER", name: { fr: "Immobilier & Construction patrimoniale", en: "Real Estate", es: "Inmobiliario", de: "Immobilien", it: "Immobiliare", ar: "العقارات" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "EDUCATION", name: { fr: "Éducation & Formation", en: "Education & Training", es: "Educación y Formación", de: "Bildung & Weiterbildung", it: "Istruzione e Formazione", ar: "التعليم والتدريب" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "PHARMA_BIOTECH", name: { fr: "Pharma, Biotech & Life Sciences", en: "Pharma, Biotech & Life Sciences", es: "Farma, Biotech y Ciencias de la Vida", de: "Pharma, Biotech & Life Sciences", it: "Pharma, Biotech e Life Sciences", ar: "الأدوية والتكنولوجيا الحيوية" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "LUXE_MODE", name: { fr: "Luxe, Mode & Beauté", en: "Luxury, Fashion & Beauty", es: "Lujo, Moda y Belleza", de: "Luxus, Mode & Beauty", it: "Lusso, Moda e Beauty", ar: "الفخامة والأزياء والجمال" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "HOTELLERIE_TOURISME", name: { fr: "Hôtellerie, Restauration & Tourisme", en: "Hospitality, Food & Tourism", es: "Hostelería, Restauración y Turismo", de: "Hotellerie, Gastronomie & Tourismus", it: "Ospitalità, Ristorazione e Turismo", ar: "الضيافة والمطاعم والسياحة" },
    positioning: RP_POSITIONING, subcategories: [
  ...
  { code: "PUBLIC_ASSOCIATIF", name: { fr: "Public, ONG & Associatif", en: "Public, NGO & Nonprofit", es: "Público, ONG y Asociativo", de: "Öffentlicher Sektor, NGO & Nonprofit", it: "Pubblico, ONG e Nonprofit", ar: "القطاع العام والمنظمات غير الربحية" },
    positioning: RP_POSITIONING, subcategories: [
