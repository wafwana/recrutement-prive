...
const spaces = [
  {
    ...
    title: "Pilotez votre parcours.",
    text: "Profil, candidatures, documents et échanges réunis dans un espace confidentiel.",
  },
  {
    href: "/espace/entreprise",
    eyebrow: "Espace entreprise",
    title: "Pilotez vos recrutements.",
    text: "Offres, profils proposés et suivi des missions dans une interface simple et claire.",
  },
  {
    href: "/espace/consultant",
    eyebrow: "Espace consultant",
    title: "Centralisez votre activité.",
    text: "Pipeline, candidats, entreprises, rendez-vous et reporting au même endroit.",
  },
];
...
export default function EspacePage() {
  return (
    <section className="mx-auto w-[min(1180px,calc(100%-40px))] py-20 md:w-[min(1180px,calc(100%-72px))] md:py-28">
      ...
      <p className="mt-7 max-w-2xl text-base leading-8 text-white/55">Choisissez votre environnement. Les parcours restent séparés pour préserver la lisibilité, la confidentialité et les responsabilités de chacun.</p>
